...
- **Uusi pakka** — avaa dialogin, johon kirjoitetaan uuden pakan nimi ja kuvaus. Nimi tarkistetaan: se ei saa olla tyhjä, saa olla enintään 20 merkkiä eikä se saa olla jo käytössä.
...
1. **Muokata pakan nimeä ja kuvausta** — muutokset tallennetaan *Tallenna pakan tiedot* -painikkeella. Sama nimi­tarkistus on käytössä kuin uutta pakkaa luotaessa, mutta nyt nykyinen pakka sallitaan.
...
Harjoittelussa pakan kortit sekoitetaan ja näytetään yksi kerrallaan:
